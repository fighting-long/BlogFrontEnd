  ...
  <el-container style="width: 850px">
    ...
    <el-main style="margin-left: 200px;width: 750px;border: 1px #DCDFE6 solid;">
                  ...
                  <el-row style="margin-top: 26px;width: 473px" id="children">
                    <el-col :span="5">
                      <div style="height: 28px;line-height: 28px">
                        ...
                        <el-link href="#/aboutme" type="info" :underline="false" style="margin-bottom:20px">{{blog.user.nickname}}</el-link>
                      </div>
                    </el-col>
                    <el-col :span="6">
                      <div style="height: 28px;line-height: 28px">
        ...
        <el-row style="height: 30px">
          <el-col :span="24" >
            <el-button plain type="primary" size="small" @click="getBlogView(--startPage,size)" :disabled="startPage===1">上一页</el-button>
            <el-button plain type="primary" size="small" @click="getBlogView(++startPage,size)" :disabled="size*startPage>total" style="float: right">下一页</el-button>
          </el-col>
        </el-row>
    </el-main>
  </el-container>
