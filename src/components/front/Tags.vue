  ...
  <el-container style="margin-top: 50px">
    <el-header style="padding: 0; width: 900px;margin: auto;line-height: normal" height="" >
      <el-card class="box-card" shadow="never">
        <div slot="header" class="clearfix">
          ...
          <span style="float: right; padding: 3px 0">共<b style="color: orange;font-size: 18px">{{tags.length}}</b>个</span>
        </div>
        <el-tag effect="plain" style="margin: 2px" type="info"
          ...
          <el-link :underline="false" style="margin-bottom: 2px" :href="'#/tag/?id='+tag.id">{{ tag.name }} &nbsp;&nbsp;&nbsp;&nbsp; {{ tag.blogCount }}</el-link>
        </el-tag>
      </el-card>
    </el-header>
    <el-main style="margin: auto;width: 900px;border: 1px #DCDFE6 solid;">
          ...
          <el-row style="height: 150px">
            <el-col :span="18" style="height: 150px">
              <el-row style="height: 150px" id="father">
                <el-col>
                  <b><el-link :underline="false" style="font-size: 18px;" :href="'#/blogDetail/'+blog.id">{{blog.title}}</el-link></b>
                </el-col>
                <el-col>
                  ...
                  <el-row style="margin-top: 26px;width: 645px" id="children">
                    <el-col :span="4">
                      <div style="height: 28px;line-height: 28px">
                        ...
                        <el-link  href="#/aboutme" type="info" :underline="false" style="margin-bottom:18px">{{blog.user.nickname}}</el-link>
                      </div>
                    </el-col>
                    <el-col :span="5">
                      <div style="height: 28px;line-height: 28px">
                    ...
                    <el-col :span="9">
                      <el-link :underline="false" :key="tag.id" v-for="tag in blog.tags" :href="'#/tag/?id='+tag.id">
                        <el-tag :effect="tag.id==activeId?'dark':'plain'" size="mini" type="info" style="margin-top: 5px;margin-right: 3px" >
                          {{tag.name}}
                        </el-tag>
                      </el-link>
                    </el-col>
        ...
        <el-row style="height: 30px">
          <el-col :span="24" >
            <el-button plain type="primary" size="small" @click="getBlogViewByTagId(--startPage,size)" :disabled="startPage===1">上一页</el-button>
            <el-button plain type="primary" size="small" @click="getBlogViewByTagId(++startPage,size)" :disabled="size*startPage>total" style="float: right">下一页</el-button>
          </el-col>
        </el-row>
    </el-main>
  </el-container>
