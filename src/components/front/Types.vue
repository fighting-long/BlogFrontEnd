  ...
  <el-container style="margin-top: 50px">
    <el-header style="padding: 0; width: 900px;margin: auto;line-height: normal" height="" >
      <el-card class="box-card" shadow="never">
        <div slot="header" class="clearfix">
          ...
          <span style="float: right; padding: 3px 0">共<b style="color: orange;font-size: 18px">{{types.length}}</b>个</span>
        </div>
        <el-tag effect="plain" style="margin: 2px" type="info"
          ...
          <el-link :underline="false" style="margin-bottom: 2px" :href="'#/type/?id='+type.id">{{ type.name }} &nbsp;&nbsp;&nbsp;&nbsp; {{ type.blogCount }}</el-link>
        </el-tag>
      </el-card>
    </el-header>
    <el-main style="margin: auto;width: 900px;border: 1px #DCDFE6 solid;">
        ...
        <el-row style="height: 30px">
          <el-col :span="24" >
            <el-button plain type="primary" size="small" @click="getBlogViewByTypeId(--startPage,size)" :disabled="startPage===1">上一页</el-button>
            <el-button plain type="primary" size="small" @click="getBlogViewByTypeId(++startPage,size)" :disabled="size*startPage>total" style="float: right">下一页</el-button>
          </el-col>
        </el-row>
    </el-main>
  </el-container>
